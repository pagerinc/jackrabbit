...
// don't run when test is parent process
let appId;
if (global.it === undefined) {
    const ParentPackageJson = require(require.main.path + '/package.json');

    appId = `${ParentPackageJson.name}@${ParentPackageJson.version}`;
}
